...
public class MapGraph {
	...
	public List<GeographicPoint> bfs (GeographicPoint start,
		...
		GraphNode from = vertices.get (start);
		GraphNode to = vertices.get (goal);
	 ...
	 */
	private boolean bfsSearch (GraphNode goal, Queue<GraphNode> toExplore,
	                           Set<GraphNode> visited, Map<GraphNode, GraphNode> parentMap,
